...
class MainWindow:
    ...
    def __init__(self):
        ...
        # <tk-designer:end id="declarations" hash="c4a6a587">
    ...
    def tkd_create_widgets(self):
        ...
        self.main_window.resizable(True, False)
        self.main_window.minsize(200, 100)
    ...
    # <tk-designer:end id="tkd_create_widgets" hash="32cff2d4">
